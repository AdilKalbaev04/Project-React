...
const Price = () => {
  return (
    ...
    <div  className={styles.text_2}>
      ...
      <h3 className={styles.ix1}>Вы купили квартиру без отделки и <br /> планируете начать ремонт; <br />
Вы приобрели квартиру с ремонтом, и не <br /> понимаете, как правильно зонировать ее и <br /> расставить мебель; <br/>
...
<h3 className={styles.ix2}>2 варианта планировки + финальный <br />
план демонтажа стен <br />
план монтажа перегородок</h3>
<div className={styles.price}>
<h3>цена услуги:</h3>
<h2 className={styles.price1}>99 000мг</h2>
</div>
<div className={styles.button1}>
<button className={styles.button} ><span><svg width="23" height="26" viewBox="0 0 23 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M16.2551 11.6992V5.75521C16.2551 4.49405 15.7541 3.28455 14.8623 2.39277C13.9705 1.50099 12.761 1 11.4998 1C10.2387 1 9.02917 1.50099 8.1374 2.39277C7.24562 3.28455 6.74463 4.49405 6.74463 5.75521V11.6992" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
 ...
 <button className={styles.button2}>Посмотреть пример</button>
    ...
    <h3 className={styles.text4}>Мы разработаем для вас уникальное <br /> планировочное решение квартиры, которое <br /> будет соответствовать как нормам <br /> эргономики, так и вашим личным <br /> пожеланиям.</h3>

<h3 className={styles.text4}>Затем мы подготовим альбом, состоящий из 12 <br /> чертежей, необходимых строителям для <br /> ремонта.</h3>

<h3 className={styles.text5}>* также, вы можете дополнительно выбрать <br /> любой дизайн из нашего каталога, и мы <br /> добавим его в ваш проект.</h3>
<h3 className={styles.ix5}>Вам подойдет,если;</h3>
<h3 className={styles.text6}>Вы купили квартиру в новостройке, и <br /> нужен чёткий план на ремонт; <br /> 

Вы хотите полностью переделать квартиру с уже готовой отделкой или вторичку;
Вы планируете бюджетный ремонт квартиры для дальнейшей сдачи в аренду.</h3>
</div>
